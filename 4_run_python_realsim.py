...
def run(folder, name, patients, run_all, save_imputed):
    ...
    X = np.genfromtxt('./data/spikeincsv/' + name + '.csv',
                      delimiter=',')[:end, 2:]

    print(X.shape, X_corrupt.shape)
    ...
    if save_imputed:
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_simple_mean.csv',
                   simple_mean_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_simple_median.csv',
                   simple_median_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_simple_random.csv',
                   random_X, delimiter=',', newline='\n'),
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_1.csv',
                   svd_1_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_2.csv',
                   svd_2_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_3.csv',
                   svd_3_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_4.csv',
                   svd_4_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_5.csv',
                   svd_5_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_6.csv',
                   svd_6_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_7.csv',
                   svd_7_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_8.csv',
                   svd_8_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_9.csv',
                   svd_9_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_10.csv',
                   svd_10_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_11.csv',
                   svd_11_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_12.csv',
                   svd_12_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_13.csv',
                   svd_13_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_14.csv',
                   svd_14_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_15.csv',
                   svd_15_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_16.csv',
                   svd_16_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_17.csv',
                   svd_17_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_18.csv',
                   svd_18_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_19.csv',
                   svd_19_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_20.csv',
                   svd_20_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_21.csv',
                   svd_21_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_22.csv',
                   svd_22_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_23.csv',
                   svd_23_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_svd_24.csv',
                   svd_24_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si.csv',
                   si_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_half.csv',
                   si_s_half_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_1.csv',
                   si_s_1_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_2.csv',
                   si_s_2_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_4.csv',
                   si_s_4_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_8.csv',
                   si_s_8_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_16.csv',
                   si_s_16_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_32.csv',
                   si_s_32_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_64.csv',
                   si_s_64_X, delimiter=',', newline='\n')
        np.savetxt('./output/sweeps/' + folder + '/' + name + '_si_s_128.csv',
    ...
    if run_all:
        ...
        if save_imputed:
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_MICE.csv',
                       mice_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name +
                       '_mice_col_lambda_reg_25.csv',
                       mice_col_lambda_reg_25, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_col_lambda_reg_10.csv',
                       mice_col_lambda_reg_10, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_col_lambda_reg_1.csv',
                       mice_col_lambda_reg_1, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_col_lambda_reg_01.csv',
                       mice_col_lambda_reg_01, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_col_lambda_reg_001.csv',
                       mice_col_lambda_reg_001, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_pmm_X.csv',
                       mice_pmm_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_pmm_lambda_reg_25.csv',
                       mice_pmm_lambda_reg_25, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_pmm_lambda_reg_10.csv',
                       mice_pmm_lambda_reg_10, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_pmm_lambda_reg_1.csv',
                       mice_pmm_lambda_reg_1, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_pmm_lambda_reg_01.csv',
                       mice_pmm_lambda_reg_01, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_mice_pmm_lambda_reg_001.csv',
                       mice_pmm_lambda_reg_001, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_1.csv',
                       knn_1_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_3.csv',
                       knn_3_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_9.csv',
                       knn_9_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_15.csv',
                       knn_15_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_30.csv',
                       knn_30_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_81.csv',
                       knn_81_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_243.csv',
                       knn_243_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_751.csv',
                       knn_751_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + '_knn_2000.csv',
                       knn_2000_X, delimiter=',', newline='\n')
            np.savetxt('./output/sweeps/' + folder + '/' + name + 'knn_6000.csv',
