...
mcar_scores <- read.csv('~/data/imputation/imputation_scores/mcar.csv')
...
mar_scores <- read.csv('~/data/imputation/imputation_scores/mar.csv')
...
mnar_scores <- read.csv('~/data/imputation/imputation_scores/mnar.csv')
...
png("../figures/figure_3.png", width = 7.5, height = 5, res = 300, units = "in")
