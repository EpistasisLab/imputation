...
png("./plots/supp_mar_knn.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./plots/supp_mar_svd.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./plots/supp_mar_si.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./plots/supp_mar_mice_col.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./plots/supp_mar_mice_pmm.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./plots/supp_mar_mice_r.png", width = 7.5, height = 5, res = 300, units = "in")
