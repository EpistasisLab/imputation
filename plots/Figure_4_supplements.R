...
png("./figures/Supplemental_Figure_3.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_4.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_5.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_6.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_7.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_8.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_9.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_10.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_11.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_12.png", width = 7.5, height = 5, res = 300, units = "in")
...
png("./figures/Supplemental_Figure_13.png", width = 7.5, height = 5, res = 300, units = "in")
...
knn_scores <- subset(mar_scores, Method %in% knn_methods)
knn_scores$Method <- factor(knn_scores$Method, levels=knn_methods)

mar_subset <- subset(knn_scores, Quartile==0)
knn1 = ggplot(mar_subset, aes(x=Method, y=MSE)) +
  geom_boxplot(outlier.colour="black", outlier.shape=1, outlier.size=1) +
  labs(title = "A. Quartile 1", y="RMSE", x="K-neighbors") +
  scale_x_discrete(labels=knn_labels) + 
...
mar_subset <- subset(knn_scores, Quartile==1)
knn2 = ggplot(mar_subset, aes(x=Method, y=MSE)) +
  geom_boxplot(outlier.colour="black", outlier.shape=1, outlier.size=1) +
  labs(title = "B. Quartile 2", y="RMSE", x="K-neighbors") +
  scale_x_discrete(labels=knn_labels) + 
  scale_y_continuous(limits=c(min_score, 2)) +
...
mar_subset <- subset(knn_scores, Quartile==2)
knn3 = ggplot(mar_subset, aes(x=Method, y=MSE)) +
  geom_boxplot(outlier.colour="black", outlier.shape=1, outlier.size=1) +
  labs(title = "C. Quartile 3", y="RMSE", x="K-neighbors") +
  scale_x_discrete(labels=knn_labels) + 
  scale_y_continuous(limits=c(min_score, 2)) +
...
mar_subset <- subset(knn_scores, Quartile==3)
knn4 = ggplot(mar_subset, aes(x=Method, y=MSE)) +
  geom_boxplot(outlier.colour="black", outlier.shape=1, outlier.size=1) +
  labs(title = "D. Quartile 4", y="RMSE", x="K-neighbors") +
  scale_x_discrete(labels=knn_labels) + 
  scale_y_continuous(limits=c(min_score, 2)) +
...
svd_scores <- subset(mar_scores, Method %in% svd_methods)
svd_scores$Method <- factor(svd_scores$Method, levels=svd_methods)
...
si_scores <- subset(mar_scores, Method %in% si_methods)
si_scores$Method <- factor(si_scores$Method, levels=si_methods)
...
mice_scores <- subset(mar_scores, Method %in% mice_methods)
mice_scores$Method <- factor(mice_scores$Method, levels=mice_methods)
...
mice_scores <- subset(mar_scores, Method %in% mice_r_methods)
mice_scores$Method <- factor(mice_scores$Method, levels=mice_r_methods)
